-- Initial database schema for Freepik AI Orchestrator

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Main tasks table for tracking generation requests
...
-- Workflows table for storing workflow templates
...
-- User analytics table for tracking usage metrics
...
(
    ...
    'High-quality professional headshots with optimal lighting',
    '[
...
(
    'product_photography',
    'Product Photography',
    'E-commerce ready product images with multiple angles',
    '[
...
(
    'marketing_materials',
    'Marketing Materials',
    'Social media and marketing content with brand consistency',
    '[
